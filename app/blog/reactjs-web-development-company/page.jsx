          ...
          <div className="container mx-auto px-4 py-6 md:py-8">
            ...
            <div className="blog-content max-w-4xl mx-auto" id="content">
              ...
              <div 
                ...
                data-aos="fade-up"
              >
                <h4 className="font-semibold mb-3 md:mb-4 text-gray-900 dark:text-white text-base md:text-lg">Share this article:</h4>
                <div className="flex gap-2 md:gap-3 justify-center sm:justify-start">
                  <Link 
                    href="#" 
                    className="social-share-button bg-blue-600 hover:bg-blue-700 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition shadow hover:shadow-md"
                  ...
                  <Link 
                    href="#" 
                    className="social-share-button bg-blue-400 hover:bg-blue-500 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition shadow hover:shadow-md"
                  ...
                  <Link 
                    href="#" 
                    className="social-share-button bg-blue-700 hover:bg-blue-800 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition shadow hover:shadow-md"
